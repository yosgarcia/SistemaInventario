...
namespace SistemaInventario.Areas.Admin.Controllers
{
    ...
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Upsert(ProductoVM productoVM)
        {
            ...
            {
                var files = HttpContext.Request.Form.Files; // Caputara todo lo que pasemos por el form (incluida imagen)
                string webRootPath = _webHostEnvironment.WebRootPath; //Capturando directorio
